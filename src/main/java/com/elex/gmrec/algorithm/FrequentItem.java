...
public final class FrequentItem extends AbstractJob {

  private static final Logger log = LoggerFactory.getLogger(FrequentItem.class);

  
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new Configuration(), new FrequentItem(), args);
  }
